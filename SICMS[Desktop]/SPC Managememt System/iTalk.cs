...
class iTalk_TabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(155, 72, 42)), new Rectangle(-5, 0, ItemSize.Height + 4, Height));
        ...
        for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
        {
            if (TabIndex == SelectedIndex)
            {
                ...
                _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(93, 85, 82)), TabRect.X, TabRect.Y, TabRect.Width - 4, TabRect.Height + 3);
                ...
                _Graphics.FillRectangle(new SolidBrush(Color.FromArgb(148, 182, 55)), TabHighlighter);
                // Draw tab text
                _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Regular), new SolidBrush(Color.FromArgb(254, 255, 255)), new Rectangle(TabRect.Left + 40, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
            ...
            {
                Rectangle TabRect = new Rectangle(new Point(GetTabRect(TabIndex).Location.X - 2, GetTabRect(TabIndex).Location.Y - 2), new Size(GetTabRect(TabIndex).Width + 3, GetTabRect(TabIndex).Height - 8));
                _Graphics.DrawString(TabPages[TabIndex].Text, new Font(Font.FontFamily, Font.Size, FontStyle.Regular), new SolidBrush(Color.FromArgb(159, 162, 167)), new Rectangle(TabRect.Left + 40, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), new StringFormat { Alignment = StringAlignment.Near });
