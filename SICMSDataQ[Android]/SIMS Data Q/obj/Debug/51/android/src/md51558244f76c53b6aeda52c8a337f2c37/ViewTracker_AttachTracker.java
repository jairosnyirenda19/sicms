...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.Platform.Android.ViewTracker+AttachTracker, Xamarin.Forms.Platform.Android", ViewTracker_AttachTracker.class, __md_methods);
	}


	public ViewTracker_AttachTracker ()
	{
		super ();
		if (getClass () == ViewTracker_AttachTracker.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.Platform.Android.ViewTracker+AttachTracker, Xamarin.Forms.Platform.Android", "", this, new java.lang.Object[] {  });
	}
