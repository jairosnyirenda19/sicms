...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Forms.Platform.Android.OpenGLRenderer+Renderer, Xamarin.Forms.Platform.Android", OpenGLRenderer_Renderer.class, __md_methods);
	}


	public OpenGLRenderer_Renderer ()
	{
		super ();
		if (getClass () == OpenGLRenderer_Renderer.class)
			mono.android.TypeManager.Activate ("Xamarin.Forms.Platform.Android.OpenGLRenderer+Renderer, Xamarin.Forms.Platform.Android", "", this, new java.lang.Object[] {  });
	}
